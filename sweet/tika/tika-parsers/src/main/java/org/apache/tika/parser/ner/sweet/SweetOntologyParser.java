 ...
 */
package org.apache.tika.parser.ner.sweet;
 ...
 *
 */
public class SweetOntologyParser implements NERecogniser {

    private static final Logger LOG = LoggerFactory.getLogger(SweetOntologyParser.class);
    ...
    public static final String NER_7CLASS_MODEL = "edu/stanford/nlp/models/ner/ner-model.sweet.gz";
    /**
     * default Model path
     */
     ...
     */
    public SweetOntologyParser(String modelPath) {
        try {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (FileInputStream stream = new FileInputStream(args[0])) {
            ...
            SweetOntologyParser ner = new SweetOntologyParser();
